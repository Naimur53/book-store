      ...
      <nav className="py-4 2xl:px-6">
        <div className="container flex items-center justify-between">
          ...
          <div className="relative group">
            ...
            <ul className="group-hover:flex  absolute top-[20px] right-0 w-[200px] md:w-auto md:static hidden md:flex bg-blue-200 shadow md:shadow-none rounded-md py-2 md:rounded-none flex-col md:flex-row  items-center  gap-2 md:gap-6 ">
